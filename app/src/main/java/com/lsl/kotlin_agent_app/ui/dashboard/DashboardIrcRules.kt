...
object DashboardIrcRules {

    fun isIrcDirAtWorkspaceRoot(
        cwd: String,
        ...
        return entry.name.trim() == "irc"
    }

    fun ircDirLongClickActions(): Array<String> {
        return arrayOf("进入目录", "打开 IRC", "剪切", "复制", "重命名", "删除", "复制路径")
    }
}
