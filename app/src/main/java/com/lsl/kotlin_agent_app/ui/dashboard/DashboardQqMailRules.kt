...
object DashboardQqMailRules {

    fun isQqMailDirAtWorkspaceRoot(
        cwd: String,
        ...
        return entry.name.trim() == "qqmail"
    }

    fun qqmailDirLongClickActions(): Array<String> {
        return arrayOf("进入目录", "打开邮箱", "剪切", "复制", "重命名", "删除", "复制路径")
    }
}
