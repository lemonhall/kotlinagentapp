...
android {
    ...
    buildTypes {
        ...
        release {
            ...
            buildConfigField("String", "DEFAULT_PROVIDER", "\"openai\"")
            ...
            buildConfigField("String", "DEFAULT_ANTHROPIC_BASE_URL", "\"\"")
            buildConfigField("String", "DEFAULT_ANTHROPIC_API_KEY", "\"\"")
            buildConfigField("String", "DEFAULT_ANTHROPIC_MODEL", "\"\"")
            buildConfigField("String", "DEFAULT_DEEPSEEK_BASE_URL", "\"\"")
            buildConfigField("String", "DEFAULT_DEEPSEEK_API_KEY", "\"\"")
            buildConfigField("String", "DEFAULT_DEEPSEEK_MODEL", "\"\"")
        ...
        debug {
            val providerVal = dotenv["PROVIDER"].orEmpty()
            val baseUrl = dotenv["OPENAI_BASE_URL"].orEmpty()
            val apiKey = dotenv["OPENAI_API_KEY"].orEmpty()
            val model = dotenv["MODEL"].orEmpty()
            val anthropicBaseUrl = dotenv["ANTHROPIC_BASE_URL"].orEmpty()
            val anthropicApiKey = dotenv["ANTHROPIC_API_KEY"].orEmpty()
            val anthropicModel = dotenv["ANTHROPIC_MODEL"].orEmpty()
            val deepseekBaseUrl = dotenv["DEEPSEEK_BASE_URL"].orEmpty()
            val deepseekApiKey = dotenv["DEEPSEEK_API_KEY"].orEmpty()
            val deepseekModel = dotenv["DEEPSEEK_MODEL"].orEmpty()
            ...
            buildConfigField("String", "DEFAULT_PROVIDER", "\"${escapedForBuildConfig(providerVal.ifBlank { "openai" })}\"")
            ...
            buildConfigField("String", "DEFAULT_ANTHROPIC_BASE_URL", "\"${escapedForBuildConfig(anthropicBaseUrl)}\"")
            buildConfigField("String", "DEFAULT_ANTHROPIC_API_KEY", "\"${escapedForBuildConfig(anthropicApiKey)}\"")
            buildConfigField("String", "DEFAULT_ANTHROPIC_MODEL", "\"${escapedForBuildConfig(anthropicModel)}\"")
            buildConfigField("String", "DEFAULT_DEEPSEEK_BASE_URL", "\"${escapedForBuildConfig(deepseekBaseUrl)}\"")
            buildConfigField("String", "DEFAULT_DEEPSEEK_API_KEY", "\"${escapedForBuildConfig(deepseekApiKey)}\"")
            buildConfigField("String", "DEFAULT_DEEPSEEK_MODEL", "\"${escapedForBuildConfig(deepseekModel)}\"")
